...
:: Проверка и завершение процесса winws.exe, если он запущен
...
:: Установка параметров запуска без list-main.txt и с исправленными кавычками
...
:: Опционально добавляем чтение list-domains.txt и list-customs-domains.txt, если они существуют
...
:: Запуск winws.exe и перенаправление вывода в лог-файлы
